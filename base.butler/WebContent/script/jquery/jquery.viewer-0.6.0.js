...
var handlers = {
  click: function click(e) {
    ...
    switch (action) {
      ...
      case 'download':
        this.download($target.data('index'));
        break;
...
var methods = {
   ...
   * custom download 
   */
  download: function donwload(index){
	...
	//TODO 다운로드
	window.location.href = $img.data('originalUrl');
